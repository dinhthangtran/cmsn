...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($conn, "UPDATE giaodich SET thoigianketthuc = '" . $_POST['thoigianketthuc'] . "', tien ='$tien', giamgia = '" . $_POST['giamgia'] . "', idgiatien = '" . $_POST['giatien'] . "' WHERE giaodich.`idmay` = '" . $_POST['idmay'] . "' AND giaodich.`thoigianbatdau` = '" . $_POST['thoigianbatdau'] . "'");
...
<div class="row">
    <div class="col-xl-12 mx-auto">
        ...
        <form method="post" action="">
            ...
            <a href="#" class="btn btn-sm btn-success mb-1" title="Sửa" data-toggle="modal" data-target="#exampleModal" data-title="Cập nhật thông tin khách hàng" data-type="update" data-idkh="<?= $row['idkh'] ?>" data-hoten="<?= $row['hoten'] ?>" data-thoigiandangky="<?= $row['thoigiandangky'] ?>" data-loaikhachhang="<?= $row['loaikhachhang'] ?>">
                                <i class="fa fa-pencil"></i> 
                            </a>
            <a href="./index.php" class="btn btn-danger px-5"><i class="fa fa-reply"></i> Trở về</a>
            <button name="submit1" type="submit" class="btn btn-primary px-5"><i class="fa fa-money"></i> Cập nhật</button>
