...
if (isset($_POST['type']) && $_POST['type'] == 'insert') {
    $queryinsert = mysqli_query($conn, "INSERT INTO `thongtinkhachhang`(`idkh`, `hoten`, `thoigiandangky`, `loaikhachhang`) VALUES (NULL, '" . $_POST['hoten'] . "', CURRENT_TIMESTAMP, '" . $_POST['loaikhachhang'] . "')");
}
$querydel = 0;
...
if (isset($_POST['type']) && $_POST['type'] == 'update') {
    $queryupdate = mysqli_query($conn, "UPDATE `thongtinkhachhang` SET `hoten`='" . $_POST['hoten'] . "',`loaikhachhang`='" . $_POST['loaikhachhang'] . "' WHERE `idkh`='" . $_POST['id'] . "'");
}
